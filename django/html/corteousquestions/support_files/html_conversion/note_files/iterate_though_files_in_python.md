451<br>
<br>
 To iterate through files in a folder, use the<br>
 following formulation to create a list of<br>
 complete URLS for all the files, as an example:<br>
...
<br>
 paths = []<br>
 folder = '/path/to/folder'<br>
 for filename in os.listdir(folder):<br>
     paths.append(os.path.join(folder, filename))<br>
 print(paths)<br>
