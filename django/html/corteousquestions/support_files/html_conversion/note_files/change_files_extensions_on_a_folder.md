704<br>
<br>
 To change all files in a folder extensions, from PHP<br>
 to HTML for example, do this:<br>
 ...
 import os<br>
 files = os.listdir(currentdir)<br>
 for file in files:<br>
    if '.php' in file:<br>
        new_file = file.replace('.php', '.html')<br>
        os.rename(file, new_file)<br>
